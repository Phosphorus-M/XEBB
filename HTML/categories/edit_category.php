...
<div class="row categories_with_forums">
  <div class="col-sm-12">
      ...
      <div class="row boxes">
        <div class="col-md-12">
          <form class="form-horizontal" action="?view=admin&section=categories&mode=edit&id=<?php echo $_GET['id']; ?>" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label"><?php echo $lang['category']; ?></label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="name" placeholder="<?php echo $lang['category_name']; ?>" value="<?php echo $_categories[$_GET['id']]['name']; ?>">
                </div>
              </div>
              <div class="form-group">
